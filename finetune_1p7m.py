...
selfies_data_train = smiles_data_train 
selfies_data_vali = smiles_data_vali

selfies_data_train['smiles'] = [convert_selfies(smi) for smi in selfies_data_train['smiles']] 
selfies_data_vali['smiles'] = [convert_selfies(smi) for smi in selfies_data_vali['smiles']] 

selfies_data_train = selfies_data_train[selfies_data_train['smiles']!=0]
selfies_data_vali = selfies_data_vali[selfies_data_vali['smiles']!=0]
...
dataset_train = Dataset.from_pandas(selfies_data_train)
dataset_vali = Dataset.from_pandas(selfies_data_vali)
...
def compute_metrics(eval_pred):
    ...
    return perplexity.compute(predictions=predictions, model_id = 'ncfrey/ChemGPT-4.7M')
